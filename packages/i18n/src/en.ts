...
export const en = {
  ...
  dashboard: {
    ...
    setupIntro: 'A few minutes and you can take your first membership.',
  ...
  ui: {
    ...
    platformColGym: 'Gym',
    platformColBranches: 'Branches',
    platformColLastPayment: 'Last payment',
    platformOpen: 'Open',
    platformCounts: '{{gyms}} gyms · {{members}} members · {{active}} active memberships',
    colAction: 'Action',
    colActive: 'Active',
    durationUnits: { months: 'Months', days: 'Days' },
    addonKinds: {
    ...
    discountKinds: {
      ...
      flat: 'Flat ₹',
      joining_fee_waiver: 'Joining fee waiver',
    },
    audiences: {
      all: 'Everyone',
      new_members: 'New members only',
      renewals: 'Renewals only',
      win_back: 'Win-back (lapsed members)',
    },
    receiptPrefixHint: 'e.g. SVF → SVF-2026-000123',
    gstinHint: '15 characters, e.g. 37ABCDE1234F1Z5. Empty = not registered, plain receipts.',
    roleNames: {
      owner: 'Owner',
    ...
    csvFile: 'CSV file',
    validateAndPreview: 'Validate & preview (dry run)',
    allowPartialPayments: 'Allow partial payments',
    oneTimePasswordNote:
      'A one-time password is generated and shown once — the staff member should change it after first sign-in.',
    newPackage: 'New package',
    newPromotion: 'New promotion',
    newTrainer: 'New trainer',
    newStaffAccount: 'New staff account',
    ptAddonPackages: 'PT & add-on packages',
    brandIdentity: 'Brand & member app identity',
    ...
    colWhen: 'When',
    colWho: 'Who',
    subStaff: 'Accounts, roles and access. Deactivation cuts access instantly.',
    subSettingsMissing: 'No settings found for this account.',
    subPlans: 'Price changes create a new version — past sales keep their original terms.',
    subImport: 'Migrate from notebooks/Excel. Nothing imports until every row is valid.',
    subAudit: 'Append-only — entries can never be edited or deleted.',
